...
export async function updateDetalleTrabajo(req: Request, res: Response) {
    try {
        ...
        if (parsedData.accesorios !== undefined) data.accesorios = parsedData.accesorios ?? null;
        ...
        if (parsedData.notas !== undefined) data.notas = parsedData.notas ?? null;
        if (parsedData.empresa_id !== undefined) data.empresa_id = parsedData.empresa_id;
        if (parsedData.equipo_id !== undefined) data.equipo_id = parsedData.equipo_id;
        if (parsedData.tecnico_id !== undefined) data.tecnico_id = parsedData.tecnico_id;
