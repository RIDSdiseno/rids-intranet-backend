...
======================================================= */
export const getUsuariosByServidor = async (
    req: Request,
    res: Response
): Promise<void> => {
    try {
...
======================================================= */
export const createUsuarioServidor = async (
    req: Request,
    res: Response
): Promise<void> => {
    try {
...
======================================================= */
export const updateUsuarioServidor = async (
    req: Request,
    res: Response
): Promise<void> => {
    try {
...
======================================================= */
export const deleteUsuarioServidor = async (
    req: Request,
    res: Response
): Promise<void> => {
    try {
