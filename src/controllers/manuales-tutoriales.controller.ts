// src/controllers/manuales-tutoriales.controller.ts
...
export async function listManualesTutoriales(req: Request, res: Response) {
    try {
        const q = listManualesSchema.parse(req.query);
        const user = (req as any).user;

        const andConditions: Prisma.ManualTutorialWhereInput[] = [];
        ...
        const where: Prisma.ManualTutorialWhereInput =
...
export async function getManualTutorialById(req: Request, res: Response) {
    try {
...
export async function createManualTutorial(req: Request, res: Response) {
    try {
...
export async function updateManualTutorial(req: Request, res: Response) {
    try {
        const id = parseId(req.params.id);
...
export async function uploadManualTutorialFile(req: Request, res: Response) {
    try {
        const file = req.file;
...
export async function deleteManualTutorial(req: Request, res: Response) {
    try {
        const id = parseId(req.params.id);
