...
async function avanzarDespuesDeCompletarEtapa({
    tx,
    bitacoraId,
    etapaActual,
    actorId,
    ...
    if (
        ...
        await tx.bitacoraEvento.create({
            data: {
                ...
                tipo:
                    TipoEventoBitacora.BITACORA_CERRADA,

                descripcion:
                    "Bitácora técnica cerrada",
            },
        });
    ...
    if (
        ...
        throw new Error(
            `No existe la etapa ${siguienteEtapaTipo} para la bitácora ${bitacoraId}`
        );
    }
    ...
    await tx.bitacoraEvento.create({
        data: {
            ...
            tipo:
                TipoEventoBitacora.ETAPA_INICIADA,

            descripcion:
                `Etapa ${siguienteEtapa.etapa} iniciada`,
        },
    });
    ...
    if (
        ...
        await tx.bitacoraTecnico.update({
            ...
            data: {
                estado:
                    EstadoBitacoraTecnico.EN_PROCESO,
            },
        });
    }
}
...
export async function actualizarEtapaBitacora(
    ...
    try {
        ...
        if (
            ...
            return res.status(409).json({
                error:
                    "Esta etapa todavía no ha sido iniciada",
            });
        }
        ...
        if (
            ...
            return res.status(409).json({
                error:
                    "La etapa está pendiente de revisión y no puede modificarse",
            });
        }
        ...
        if (
            ...
            return res.status(409).json({
                error:
                    "La etapa ya fue finalizada y no puede modificarse",
            });
        }
        ...
        if (
            ...
            return res.status(400).json({
                error:
                    "El campo requiereRevision debe ser booleano",
            });
        }

        const tieneHistorialRevision =
...
export async function solicitarRevisionEtapa(
    ...
    try {
        ...
        if (
            ...
            return res.status(409).json({
                error:
                    "Debes registrar una descripción de la etapa antes de solicitar revisión",
            });
        }
        ...
        if (
            ...
            return res.status(409).json({
                error:
                    "La etapa no se encuentra disponible para solicitar revisión",
            });
        }
        ...
        if (
            ...
            return res.status(409).json({
                error:
                    "Ya existe una solicitud de revisión pendiente para esta etapa",
            });
        }
...
export async function responderRevisionEtapa(
    ...
    try {
        ...
        if (
            ...
            return res.status(400).json({
                error:
                    "El campo aprobar debe ser booleano",
            });
        }
        ...
        if (
            ...
            return res.status(404).json({
                error:
                    "Solicitud de revisión no encontrada",
            });
        }
        ...
        if (
            ...
            return res.status(403).json({
                error:
                    "Solo el revisor asignado puede responder esta revisión",
            });
        }
        ...
        const resultado =
            await prisma.$transaction(
                async (
                    ...
                    const actualizada =
                        await tx.bitacoraAprobacion.update({
                            where: {
                                id:
                                    aprobacion.id,
                            },
    ...
    error
        ...
        console.error(
            "❌ Error respondiendo revisión:",
            error
        );

        return res.status(500).json({
            error:
                "Error al responder la revisión",
        });
    }
}
...
export async function completarEtapaBitacora(
    ...
    try {
        ...
        if (
            ...
            return res.status(409).json({
                error:
                    "Debes registrar una descripción de la etapa antes de completarla",
            });
        }
 ...
 */
                ...
                async (
                    ...
                    await tx.bitacoraEvento.create({
                        data: {
                            ...
                            tipo:
                                TipoEventoBitacora.ETAPA_COMPLETADA,

                            descripcion:
                                `Etapa ${etapa.etapa} completada`,
                        },
                    });
    ...
    error
        ...
        console.error(
            "❌ Error completando etapa:",
            error
        );

        return res.status(500).json({
            error:
                "Error al completar la etapa",
        });
    }
}