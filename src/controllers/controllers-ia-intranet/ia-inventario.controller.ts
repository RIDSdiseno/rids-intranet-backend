// src/controllers/ia-intranet-controller/ia-inventario.controller.ts
...
type EquipoHallazgoNormalizado = {
     ...
     * Nunca se confía en la IA para estos campos.
     */
    serial: string | null;
    marca: string | null;
    modelo: string | null;
    ...
    /*
     * Estos dos campos sí son generados por IA,
     * porque corresponden al análisis técnico.
     */
    motivo: string;
    mejora: string;
};
