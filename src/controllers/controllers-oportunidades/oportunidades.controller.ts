// src/controllers/controllers-oportunidades/oportunidades.controller.ts
...
import {
  ...
  listarOportunidades,
  obtenerFunnel,
  obtenerDashboardFunnel,
  obtenerOportunidadPorId,
  editarOportunidad,
  cambiarEtapaOportunidad,
  reordenarOportunidad,
  desactivarOportunidad,
  crearSeguimiento,
  listarSeguimientos,
  obtenerHistorial,
  listarCotizacionesOportunidad,
  vincularCotizacion,
  desvincularCotizacion,
  OportunidadNoEncontradaError,
  EtapaOportunidadInvalidaError,
  CierreOportunidadInvalidoError,
  ResponsableOportunidadInvalidoError,
  EntidadOportunidadInvalidaError,
  OrdenOportunidadInvalidoError,
  CotizacionOportunidadRequeridaError,
  CotizacionYaVinculadaError,
  CotizacionNoEncontradaError,
  CotizacionNoVinculadaError,
  DesvinculacionCotizacionInvalidaError,
...
function manejarErrorOportunidad(err: unknown, res: Response) {
...
export async function crearOportunidadController(req: Request, res: Response) {
  ...
  if (!actorId) return res.status(401).json({ success: false, code: "NO_AUTENTICADO" });
...
export async function listarOportunidadesController(req: Request, res: Response) {
...
export async function obtenerFunnelController(_req: Request, res: Response) {
  try {
...
export async function obtenerOportunidadController(req: Request, res: Response) {
  const parsed = idParamSchema.safeParse(req.params);
  if (!parsed.success) return res.status(400).json({ success: false, code: "ID_INVALIDO" });
...
export async function editarOportunidadController(req: Request, res: Response) {
  const params = idParamSchema.safeParse(req.params);
  if (!params.success) return res.status(400).json({ success: false, code: "ID_INVALIDO" });
...
export async function cambiarEtapaController(req: Request, res: Response) {
  const params = idParamSchema.safeParse(req.params);
  if (!params.success) return res.status(400).json({ success: false, code: "ID_INVALIDO" });
...
export async function reordenarController(req: Request, res: Response) {
  const params = idParamSchema.safeParse(req.params);
  if (!params.success) return res.status(400).json({ success: false, code: "ID_INVALIDO" });
...
export async function eliminarOportunidadController(req: Request, res: Response) {
  const params = idParamSchema.safeParse(req.params);
  if (!params.success) return res.status(400).json({ success: false, code: "ID_INVALIDO" });
...
export async function crearSeguimientoController(req: Request, res: Response) {
  const params = idParamSchema.safeParse(req.params);
  if (!params.success) return res.status(400).json({ success: false, code: "ID_INVALIDO" });
...
export async function listarSeguimientosController(req: Request, res: Response) {
  const params = idParamSchema.safeParse(req.params);
  if (!params.success) return res.status(400).json({ success: false, code: "ID_INVALIDO" });
...
export async function listarCotizacionesController(req: Request, res: Response) {
  const params = idParamSchema.safeParse(req.params);
  if (!params.success) return res.status(400).json({ success: false, code: "ID_INVALIDO" });
...
export async function vincularCotizacionController(req: Request, res: Response) {
...
export async function desvincularCotizacionController(req: Request, res: Response) {
  const params = idOportunidadCotizacionParamSchema.safeParse(req.params);
  if (!params.success) return res.status(400).json({ success: false, code: "ID_INVALIDO" });
