...
} from "./cobranza-empresa.config.js";
...
export function construirAsuntoCobranza(
    params: {
        empresaKey:
        EmpresaKey;
...
function construirHtmlCobranza(
    params:
        EnviarCorreoCobranzaParams
): string {
    const config =
        getConfigCorreoEmpresa(
            params.empresaKey
...
export async function enviarCorreoCobranza(
    params:
        EnviarCorreoCobranzaParams
): Promise<
    ResultadoEnvioCorreoCobranza
> {
    try {
        const emailDestino =
            params.emailDestino
 ...
 */
        ...
        if (
            ...
            if (
                ...
                throw new Error(
                    "Envío real de cobranza bloqueado: configura COBRANZA_TEST_EMAIL o COBRANZA_LIVE_SEND=true."
                );
            }
        ...
        console.log(
            "[COBRANZA EMAIL] 📤 Preparando correo",
            {
                empresa:
                    params
                        .empresaKey,
    ...
    error
        ...
        console.error(
            "[COBRANZA EMAIL] ❌ Error enviando correo",
            {
                folio:
                    params
                        .folio,
