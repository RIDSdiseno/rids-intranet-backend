...
} from "./factura-envio-automatico.service.js";
...
async function intentarTomarConsulta(
    id: number,
    ahora: Date
): Promise<boolean> {
    /*
    ...
    if (
        ...
        console.log(
            "[FACTURA SCHEDULER] 🔒 Consulta tomada por otra instancia",
            {
                configId:
                    id,
...
async function procesarConfiguracion(
    ...
    if (
        ...
        if (
            ...
            console.log(
                "[FACTURA SCHEDULER] ⏭ Consulta ya tomada este minuto",
                {
                    empresa,
                    horaActual,
                }
            ...
            console.log(
                "[FACTURA SCHEDULER] 🔎 Preparando facturas",
                {
                    empresa,
                    horaActual,
                }
            ...
            try {
                ...
                console.log(
                    "[FACTURA SCHEDULER] ✅ Preparación terminada",
                    {
                        empresa,
            ...
            error
                ...
                console.error(
                    "[FACTURA SCHEDULER] ❌ Error preparando facturas",
                    {
                        empresa,
    ...
    if (
        ...
        if (
            ...
            console.log(
                "[FACTURA SCHEDULER] ⏭ Envío ya tomado este minuto",
                {
                    empresa,
                    horaActual,
                }
        ...
        console.log(
            "[FACTURA SCHEDULER] 📤 Procesando pendientes",
            {
                empresa,
                horaActual,
            }
...
export async function ejecutarCicloFacturasAutomaticas() {
    if (
        ...
        console.log(
            "[FACTURA SCHEDULER] ⏭ Ciclo anterior todavía en ejecución"
        );
    ...
    error
        ...
        console.error(
            "[FACTURA SCHEDULER] ❌ Error general",
            {
                error:
                    error instanceof Error
                        ? error.message
...
export function iniciarSchedulerFacturasAutomaticas() {
    ...
    console.log(
        "[FACTURA SCHEDULER] ✅ Scheduler iniciado"
    );
