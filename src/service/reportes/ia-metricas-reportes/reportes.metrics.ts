// src/service/ia-metricas-reportes/reportes.metrics.ts

export const asBool = (v: unknown) =>
    v === true || v === 1 || v === "1";

export function contarMantenimientos(visitas: any[]) {
...
export function contarExtras(visitas: any[]) {
...
export function contarTiposVisita(visitas: any[]) {
...
export function obtenerTopUsuariosGeneral(
    visitas: any[],
    tickets: any[]
) {
