...
async function main() {
    ...
    console.log(
        "[MIGRACIÓN FACTURACIÓN] COMPLETANDO CONTACTOS CRM"
    );
    ...
    let receptoresEncontrados =
        0;

    let receptoresCreados =
        0;

    let contactosEvaluados =
        0;
    ...
    for (
        ...
        if (
            ...
            console.log(
                "[MIGRACIÓN FACTURACIÓN] ⏭ Empresa sin RUT",
                {
                    empresaId:
                        empresa.id_empresa,
        ...
        if (
            ...
            console.log(
                "[MIGRACIÓN FACTURACIÓN] ➕ Receptor faltante creado",
                {
                    receptorId:
                        receptor.id,
        ...
        for (
            ...
            if (
                ...
                console.log(
                    "[MIGRACIÓN FACTURACIÓN] ⏭ Contacto sin email",
                    {
                        empresaId:
                            empresa.id_empresa,
            ...
            if (
                ...
                console.log(
                    "[MIGRACIÓN FACTURACIÓN] ↔ Contacto ya existente",
                    {
                        receptorId:
                            receptor.id,
            ...
            console.log(
                "[MIGRACIÓN FACTURACIÓN] ✅ Contacto agregado",
                {
                    receptorId:
                        receptor.id,
...
main()
    .then(
        async () => {
            ...
            console.log(
                "✅ Migración complementaria terminada"
            );
        }
    )
    .catch(
        async (
            ...
            console.error(
                "❌ Error en migración complementaria",
                error
            );
