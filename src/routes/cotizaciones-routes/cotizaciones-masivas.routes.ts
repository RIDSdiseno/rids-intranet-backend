...
import {
    listarPlantillasMasivas,
    crearPlantillaMasiva,
    generarCotizacionesDesdePlantilla,
    desactivarPlantillaMasiva,
    createCotizacionesMasivas,
    actualizarPlantillaMasiva
} from "../../controllers/controllers-cotizaciones/cotizaciones-masivas.controller.js";
