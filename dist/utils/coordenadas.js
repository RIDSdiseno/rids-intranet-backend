 ...
 */
export function clasificarCoordenadas(latitud, longitud) {
    const latOmitida = latitud === undefined;
    const lngOmitida = longitud === undefined;
    if (latOmitida && lngOmitida)
        return "OMITIDAS";
    if (latOmitida !== lngOmitida)
        return "INVALIDAS";
...
export const MENSAJE_COORDENADAS_INVALIDAS = "Coordenadas inválidas: envía latitud y longitud juntas, ambas numéricas y dentro de rango (-90 a 90 / -180 a 180), o ambas null para eliminarlas.";
