...
function detectarAnioExplicito(texto) {
...
function detectarAnioPorModelo(modelo, marca) {
...
function detectarAnioHpPorSerial(serial) {
...
export function calcularAnioPcDesdeSerial(serial, marca, modelo, procesador) {
    const serialLimpio = serial?.trim().toUpperCase() ?? "";
    const marcaLimpia = marca?.trim().toUpperCase() ?? "";
...
export function normalizarAnioPc(value) {
    if (value === undefined || value === null || value === "") {
        return null;
    }
    return validarAnio(Number(value));
}
function detectarAnioPorProcesador(procesador) {
...
//# sourceMappingURL=anio-pc.util.js.map