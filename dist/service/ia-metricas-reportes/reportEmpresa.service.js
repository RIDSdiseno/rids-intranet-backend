...
export async function buildReporteEmpresaData(empresaId, ym) {
    ...
    const topUsuariosGeneral = obtenerTopUsuariosGeneral(visitas, ticketsDetalle);
    /* =====================
    ...
    ===================== */
    const narrativa = {
        resumen: `Durante el periodo ${ym}, se realizaron ${visitasCount} visitas técnicas con una duración promedio de ${formatMs(avgMs)} por intervención.`
    };
    /* =====================
       RETURN FINAL
    ===================== */
