 ...
 */
export async function sincronizarRecordatorioBitacora(params) {
    const { bitacoraId, tecnicoId, titulo, descripcion, recordatorioAt, } = params;
    ...
    if (existente) {
        return prisma.recordatorio.update({
            ...
            data: {
                titulo: tituloFinal,
                mensaje: descripcion,
                fechaProgramada: recordatorioAt,
 ...
 */
export async function sincronizarRecordatorioTicket(params) {
    const { ticketId, tecnicoId, titulo, descripcion, recordatorioAt, } = params;
    /*
    ...
    const mensajeFinal = descripcion?.trim() ||
