...
function obtenerLinkBitacora(bitacoraId) {
    if (!APP_URL) {
        return null;
    }
...
===================================================== */
export async function enviarCorreoSolicitudRevisionBitacora(params) {
    if (!params
        .destinatarioEmail
        .trim()) {
        return;
    ...
    await transporter.sendMail({
        ...
        subject: `Solicitud de revisión · ${titulo} · ${etapaLabel}`,
        html: `
            <div
                style="
                    margin:0;
            ...
            >
                ...
                >
                    ...
                    >
                        <p>
    Hola <strong>${escaparHtml(params.destinatarioNombre)}</strong>,
</p>

                        <p>
                            <strong>
                                ${escaparHtml(params.solicitadoPorNombre)}
                            </strong>
            ...
            ? `
                                    ...
                                    >
                                        ...
                                        <div style="margin-top:6px;">
                                            ${escaparHtml(params.comentarioSolicitud)}
                                        </div>
                                    </div>
                                `
            : ""}
...
===================================================== */
export async function enviarCorreoResultadoRevisionBitacora(params) {
    if (!params
        .destinatarioEmail
        .trim()) {
        return;
            ...
            : "#b91c1c"};
                    ...
                    >
                        <p>
                            Hola
                            <strong>
                                ${escaparHtml(params.destinatarioNombre)}
                            </strong>,
                        </p>
            ...
            ? `
                ...
                : "#fef2f2"};
                                    ...
                                    >
                                        ...
                                        <div style="margin-top:6px;">
                                            ${escaparHtml(params.comentarioRespuesta)}
                                        </div>
                                    </div>
                                `
            : ""}
