...
export declare function crearSucursal(req: Request, res: Response): Promise<Response>;
export declare function obtenerFichaSucursal(req: Request, res: Response): Promise<Response>;
export declare function actualizarFichaSucursal(req: Request, res: Response): Promise<Response>;
