 ...
 */
function resolverDestinoAgenda(agenda) {
 ...
 */
function resolverDestinoPorInferencia(empresa) {
    if (!empresa)
        return null;
...
export async function listarAgendasMapa(req, res) {
    try {
...
//# sourceMappingURL=mapa-agendas.controller.js.map