...
export async function listCotizacionesEnviadas(_req, res) {
    try {
...
export async function createCotizacionEnvio(req, res) {
    try {
        ...
        let clienteNombre = clienteBody ?? null;
        let creadoPor = creadoBody ?? null;
        let fechaCreacion = fechaBody ? new Date(fechaBody) : null;
...
export async function deleteCotizacionEnvio(req, res) {
    try {
...
//# sourceMappingURL=cotizaciones-enviadas.controller.js.map