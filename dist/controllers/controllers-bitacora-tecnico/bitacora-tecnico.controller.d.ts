...
export declare function crearBitacoraTecnico(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
export declare function obtenerBitacorasTecnico(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
export declare function obtenerBitacoraTecnicoPorId(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
