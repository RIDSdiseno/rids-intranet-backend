...
===================================================== */
export async function cancelarTodosMisRecordatorios(req, res) {
    try {
        /*
        ...
        if (recordatoriosPendientes.length === 0) {
            return res.json({
                message: "No existen recordatorios pendientes para cancelar.",
                cantidad: 0,
            });
        }
        const ahora = new Date();
         ...
         */
        const bitacoraIds = Array.from(new Set(recordatoriosPendientes
        ...
        return res.json({
            message: "Todos los recordatorios pendientes fueron eliminados correctamente.",
        ...
        return res.status(500).json({
            error: "No fue posible eliminar todos los recordatorios.",
        });
    }
}
