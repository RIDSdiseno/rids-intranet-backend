...
export declare function eliminarVisitasLote(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
...
export declare function crearVisitasManualLote(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
