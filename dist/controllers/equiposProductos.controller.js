...
export async function updateProducto(req, res) {
    try {
        ...
        const dataWithOperators = {};
        if (data.nombre !== undefined)
            dataWithOperators.nombre = { set: data.nombre };
        if (data.descripcion !== undefined)
            dataWithOperators.descripcion = { set: data.descripcion ?? null };
        if (data.precio !== undefined)
            dataWithOperators.precio = { set: data.precio };
        if (data.stock !== undefined)
            dataWithOperators.stock = { set: data.stock };
        if (data.marca !== undefined)
            dataWithOperators.marca = { set: data.marca };
...
//# sourceMappingURL=equiposProductos.controller.js.map