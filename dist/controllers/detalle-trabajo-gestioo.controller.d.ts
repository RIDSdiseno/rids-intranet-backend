...
export declare function createDetalleTrabajo(req: Request, res: Response): Promise<void>;
export declare function getDetallesTrabajo(_req: Request, res: Response): Promise<void>;
