...
import { uploadTicketAttachments, MAX_TICKET_ATTACHMENT_SIZE_MB, MAX_TICKET_ATTACHMENTS, } from "../config/multer-tickets.js";
export function handleTicketAttachmentsUpload(req, res, next) {
    uploadTicketAttachments.array("attachments", MAX_TICKET_ATTACHMENTS)(req, res, (err) => {
        ...
        if (err instanceof multer.MulterError) {
            ...
            if (err.code === "LIMIT_UNEXPECTED_FILE") {
                return res.status(400).json({
                    ok: false,
                    message: "El campo de archivos adjuntos no es válido. El campo esperado es attachments.",
                });
            }
            return res.status(400).json({
                ok: false,
...
//# sourceMappingURL=ticket-attachments-upload.middleware.js.map