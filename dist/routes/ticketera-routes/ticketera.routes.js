...
// =======================
ticketeraRouter.get("/attachments/:attachmentId/download", auth(), onlyOwnEmpresa(), downloadTicketAttachment);
// =======================
...
ticketeraRouter.get("/:id", auth(), onlyOwnEmpresa(), getTicketById);
