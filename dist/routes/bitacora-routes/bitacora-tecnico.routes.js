...
import { crearBitacoraTecnico, obtenerBitacorasTecnico, obtenerBitacoraTecnicoPorId, actualizarBitacoraTecnico, actualizarRecordatorioBitacora, eliminarBitacoraTecnico, obtenerOpcionesRelacionBitacora, } from "../../controllers/controllers-bitacora-tecnico/bitacora-tecnico.controller.js";
import { agregarEvidenciaBitacora, obtenerEvidenciasBitacora, eliminarEvidenciaBitacora, } from "../../controllers/controllers-bitacora-tecnico/bitacora-evidencias.controller.js";
import { actualizarEtapaBitacora, completarEtapaBitacora, obtenerEtapasBitacora, responderRevisionEtapa, solicitarRevisionEtapa, } from "../../controllers/controllers-bitacora-tecnico/bitacora-etapas.controller.js";
import { uploadBitacoraEvidencia, } from "../../middlewares/bitacora-evidencias-upload.middleware.js";
