...
import { listEquipoAdicionales, listAdicionalesByEquipo, getEquipoAdicional, createEquipoAdicional, updateEquipoAdicional, deleteEquipoAdicional, exportEquipoAdicionales, } from "../../controllers/controllers-equipos-adicionales/equipo-adicional.controller.js";
const router = Router();
router.get("/", listEquipoAdicionales);
router.get("/equipo/:equipoId", listAdicionalesByEquipo);
router.get("/export", exportEquipoAdicionales);
