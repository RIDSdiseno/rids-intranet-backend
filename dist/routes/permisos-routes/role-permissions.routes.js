...
import { listRolePermissions, setRolePermissions, } from "../../controllers/permisos-controller/role-permissions.controller.js";
const router = Router();
router.get("/", auth(), onlyRole("ADMIN"), listRolePermissions);
router.put("/", auth(), onlyRole("ADMIN"), setRolePermissions);
export default router;
//# sourceMappingURL=role-permissions.routes.js.map